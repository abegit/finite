...
<div id="blog" class="wrapper lt">
        <div class="row">
            ...
            <?php endwhile; ?>
            <div class="large-12 columns text-center btn container ani"><?php posts_nav_link(' or ', 'Newer <i class="icon-fastright r"></i></a>', '<i class="icon-fastleft"></i>Older</a>'); ?></div><?php endif; ?>
        <?php endif; ?>
        </div> <!-- end row -->
<div class="clear"></div>
</div>
