			    	...
			    	<div class="section-header">
			              <div class="row" style="height: 200px; padding: 50px 0;">
							...
							<?php if (has_post_thumbnail( $post->ID ) ) { ?>
				            	...
				            	<div style="color:#999"><?php echo do_shortcode('[ssba]'); ?></div>
				            </div>
				            <div class="columns large-3 small-12 info">
				            	<p>The Goods!</p>
				            	<a class="btn" href="http://unscene.us/podcast-creator/download">Download</a>
